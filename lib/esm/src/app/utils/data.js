var datos = [
    ...
    { key: 'Puesto del jefe inmediato', value: [
            'CHIEF EXECUTIVE OFFICER - CEO',
            'CHIEF OPERANTING OFFICER - COO',
            'CHIEF FINANCIAL OFFICE - CFO',
            'BUSSINES MANAGER',
...
var responsabilidades = [
    {
        ...
        descripcion: 'Recibir del GERENTE DE ADMINISTRACIÓN DE PEDIDOS Y SERVICIO AL CLIENTE los compromisos pactados con los clientes, analizar la factibilidad, establecer los recursos necesarios para la producción como, cantidad de personal necesario, herramentales para la producción, maquinaria, equipos e instalaciones.',
        medidor: 'Estudio de la factibilidad para la fabricación, documentado y firmado por todas las partes involucradas.Factibilidad en números %',
    },
    {
        titulo: '3.2 PAQUETE TÉCNICO',
        descripcion: 'Recibir del proceso INGENIERIA DE DESARROLLO el paquete técnico completo para iniciar la producción de los nuevos modelos.',
        medidor: 'Validación y firma del check list del paquete técnico disponible para iniciar la producción. Paquete entregado conforme a fecha programada.',
    },
    {
        titulo: '3.3 PRODUCTOS LIBERADOS PDP',
        descripcion: 'Validar, planear que los tiempos del proceso de implementación en el PDP se cumplan en tiempo con el objetivo de hacer factibles los nuevos proyectos en calidad, en tiempo, forma y la definición de los procesos, conforme requiere el GERENTE DE ADMINISTRACIÓN DE PEDIDOS Y SERVICIO AL CLIENTE fechas de entregas pactadas con los clientes.',
        medidor: 'Indicador de puntualidad de PDP implementación Versus Análisis de Factibilidad. Indicador de puntualidad PDP.',
    },
    {
        titulo: '3.4 PROGRAMACIÓN DE LA SEMANA',
        descripcion: 'Actuar sobre el proceso de SEMANA DE PROGRAMACIÓN para que se elabore la programación de las fábricas, contemplando todos los documentos de seguimiento de la producción, abastecimiento de los materiales, herramentales, maquinaria, fecha de entrega, Etc.',
        medidor: 'Cumplimiento de los programas semanales y cierre de pedidos = < 3 programas abiertos. Pares producidos Versus pares programados',
    },
    {
        titulo: '3.5 EFICIENCIA',
        descripcion: 'Medir diariamente el desempeño (eficiencias) de los procesos, asegurar y controlar los resultados de esta medición para generar el presupuesto compatible con los sueldos a pagar. Supervisar y validar la correcta asignación de salarios de acuerdo con las categorías establecidas por la empresa y la gestión de las plantillas de producción. (ESTRUCTURA DE PUESTOS Y FUNCIONES OPERATIVAS)',
        medidor: 'Medir y gestionar las deviaciones en la nómina conforme a la política establecida. Pares producidos Versus Eficiencia lograda %',
    },
    {
        titulo: '3.6 RUTINAS DEL SUPERVISOR',
        descripcion: 'Auditar los procesos de fabricación en conjunto con el líder del área Rutina del Supervisor y corroborar, en el documento de Rutinas del Supervisor que los procesos sean de acuerdo con lo implementado, conforme a las especificaciones de proceso y la muestra física.',
        medidor: [
    ...
    },
    {
        ...
        descripcion: 'Actuar continuamente como interlocutor para las acciones correctivas conforme sean necesarias para mejorar la satisfacción del cliente en todo lo que se refiere al proceso y mejora de la calidad, costos y productividad.',
        medidor: 'Gestionar los procesos de mejora y nuevos proyectos para mejorar la satisfacción del cliente. Acciones correctivas cerradas, Círculos de Calidad cerrados.',
    },
];
var perfil = [
...
var competenciasComportamentales = [
...
var autoridades = [
    { autoridad: '1. MODIFICAR METAS DE PRODUCCIÓN.' },
    { autoridad: '2. MODIFICAR TIEMPOS DE OPERACIONES Y COSTOS.' },
    { autoridad: '3. REACOMODAR PERSONAL OPERATIVO.' },
    { autoridad: '4. AUTORIZAR CAMBIOS DE CATEGORÍA DE SUELDOS.' },
    { autoridad: '5. ACEPTAR O RECHAZAR CANDIDATOS A PUESTOS DE INGENIERÍA.' },
    { autoridad: '6. DETENER PROCESOS DE FABRICACIÓN FUERA DE ESPECIFICACIÓN.' }
];
var controlDocumento = [
    { key: 'elaboro', value: [
            'CHIEF EXECUTIVE OFFICER - CEO',
            'CHIEF OPERANTING OFFICER - COO',
            'CHIEF FINANCIAL OFFICE - CFO',
